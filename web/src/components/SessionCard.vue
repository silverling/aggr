...
<template>
	<article data-anchor="session-card" class="grid gap-3.5 rounded-card border border-line bg-surface-strong p-4.5">
		...
		<p class="wrap-break-word text-sm text-ink-soft">User agent: {{ props.session.userAgent ?? 'Unknown' }}</p>
