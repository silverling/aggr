...
<template>
	<aside
		...
		class="absolute bottom-0 right-[-304px] top-0 z-20 hidden w-[280px] min-[1848px]:block"
		aria-label="Pending model disable rule changes"
	>
		<div
			class="sticky top-6 w-[280px] rounded-[24px] border border-[rgba(24,34,47,0.12)] bg-[rgba(255,252,247,0.78)] p-4 shadow-[0_20px_48px_rgba(22,34,49,0.12)] backdrop-blur-[18px]"
		>
