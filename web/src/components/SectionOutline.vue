...
<template>
	<aside class="absolute bottom-0 left-0 top-0 z-20 hidden w-0 overflow-visible min-[1848px]:block" aria-label="Dashboard section outline">
		<div class="sticky top-6 left-[-244px]">
			<div
